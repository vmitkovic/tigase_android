...
public class FileTransferUtility {
	...
	public static final String[] FEATURES = { Socks5BytestreamsModule.XMLNS_BS, FileTransferModule.XMLNS_SI_FILE };
	...
	public static JID getBestJidForFeatures(JaxmppCore jaxmpp, BareJID jid, String[] features) {
		try {
			...
			Map<String, Presence> allPresences = PresenceModule.getPresenceStore(jaxmpp.getSessionObject()).getPresences(jid);
	...
	public static String resolveFilename(Context activity, Uri uri, String mimetype) {
		if (uri == null)
			return "";
